...
namespace NEAT {
    ...
    class EPropLearner {
        ...
        std::vector<double> BroadcastOutputSignals(const std::vector<double> &output_signals) const;
        void AccumulateDirectSignals(NeuralNetwork &network, const std::vector<double> &neuron_signals, double time_step);
       ...
       public:
        ...
        EPropStepResult TrainStep(NeuralNetwork &network, const std::vector<double> &inputs, const std::vector<double> &targets, double time_step = -1.0);
        ...
        void AccumulateLearningSignals(NeuralNetwork &network, const std::vector<double> &learning_signals, double time_step = -1.0);
        ...
        const std::vector<double> &FeedbackMatrix() const { return m_feedback; }
